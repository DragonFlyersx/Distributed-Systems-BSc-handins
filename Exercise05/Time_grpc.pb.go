...
const (
	TimeService_GetCurrentTime_FullMethodName = "/time.TimeService/GetCurrentTime"
)
...
type TimeServiceClient interface {
	GetCurrentTime(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error)
}
...
func (c *timeServiceClient) GetCurrentTime(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error) {
...
type TimeServiceServer interface {
	GetCurrentTime(context.Context, *TimeRequest) (*TimeResponse, error)
...
func (UnimplementedTimeServiceServer) GetCurrentTime(context.Context, *TimeRequest) (*TimeResponse, error) {
...
func _TimeService_GetCurrentTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServiceServer).GetCurrentTime(ctx, req.(*TimeRequest))
	}
