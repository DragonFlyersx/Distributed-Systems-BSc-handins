...
type ChittyChatClient interface {
	BroadcastMessage(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error)
...
func (c *chittyChatClient) BroadcastMessage(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
...
type ChittyChatServer interface {
	BroadcastMessage(*Empty, grpc.ServerStreamingServer[ChatMessage]) error
...
func (UnimplementedChittyChatServer) BroadcastMessage(*Empty, grpc.ServerStreamingServer[ChatMessage]) error {
...
func _ChittyChat_BroadcastMessage_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChittyChatServer).BroadcastMessage(m, &grpc.GenericServerStream[Empty, ChatMessage]{ServerStream: stream})
}
